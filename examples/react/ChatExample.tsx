  ...
  const chatScroll = useChatScroll<Message>({
    ...
    onLoadTop: () => {
      ...
      return Array.from({ length: 10 }, (_, index) =>
        buildMessage(nextFirstId + index)
      );
    },
    onMergeTop: (incoming) => {
      setMessages((current) =>
  ...
  return (
    <section style={styles.shell}>
      <header style={styles.header}>
        <div>
          <h2 style={styles.title}>Operations room</h2>
        ...
        {messages.map((message) => (
          ...
          >
            <div
              style={{
                ...styles.bubble,
                ...(message.mine ? styles.outgoingBubble : styles.incomingBubble)
              }}
            >
